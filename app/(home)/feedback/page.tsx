...
const FeedbackPage = () => {
	...
	if (isSubmitted) {
		return (
			<div className="min-h-screen bg-liner-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center px-4">
	...
	return (
		<div className="min-h-screen bg-liner-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 py-12 px-4">
						...
						<div className="mb-8">
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
								<button
									...
									className={`p-4 rounded-lg border-2 flex flex-col items-center transition-all duration-300 ${feedbackType === "suggestion"
								...
								<button
									...
									className={`p-4 rounded-lg border-2 flex flex-col items-center transition-all duration-300 ${feedbackType === "issue"
